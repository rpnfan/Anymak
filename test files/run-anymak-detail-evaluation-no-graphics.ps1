...
# ----- SETUP start -------------
$exePath = ".\opte33.exe"
$layoutfile = "Layout_3x6_anymak.txt"
    $description = "anymak-end" # short description of the general layout type
$configfile = "key-arrangement_3x6_anymak.cfg"
...
Get-Content -Path "languages2test.txt" | ForEach-Object {
    ...
    & $exePath -3 $language_file -r $layoutfile -b 15 -b 15 -b 15 -K $configfile > $outputFile
